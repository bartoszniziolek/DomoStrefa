  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Błąd przesyłania obrazu (obraz musi mieć mniej niż 2 mb)
            </span>
      ...
      <p className="text-green-700 mt-5">
        {updateSuccess ? "Użytkownik został pomyślnie zaktualizowany!" : ""}
      </p>
      <button onClick={handleShowListings} className="text-green-700 w-full">
        Pokaż ogłoszenia
      </button>
      <p className="text-red-700 mt-5">
        {showListingsError ? "Błąd wyświetlania ogłoszeń" : ""}
      </p>
            ...
            >
              ...
              <div className="flex flex-col item-center">
                ...
                <Link to={`/update-listing/${listing._id}`}>
                  <button className="text-green-700 uppercase">Edytuj</button>
                </Link>
              </div>
            </div>
          ))}
